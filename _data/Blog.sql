...
CREATE TABLE IF NOT EXISTS `blog`.`article` (
  ...
  `vote_up` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '投票：赞',
  `vote_down` INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '投票：踩',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `blog`.`tags` (
  ...
  `name` CHAR(20) NOT NULL DEFAULT '' COMMENT '标签名称',
  `description` VARCHAR(45) NOT NULL DEFAULT '' COMMENT '标签说明',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC))
ENGINE = InnoDB
COMMENT = '文章标签表';
...
-- -----------------------------------------------------
-- Table `blog`.`article_tags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog`.`article_tags` ;
...
CREATE TABLE IF NOT EXISTS `blog`.`article_tags` (
  ...
  INDEX `fk_article_tags_article1_idx` (`article_id` ASC),
  INDEX `fk_article_tags_tags1_idx` (`tags_id` ASC),
  CONSTRAINT `fk_article_tags_article1`
    FOREIGN KEY (`article_id`)
    REFERENCES `blog`.`article` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
